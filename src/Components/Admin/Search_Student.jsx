...
const Search_Student = () => {
  ...
  const [editedFamilyMember, setEditedFamilyMember] = useState(null);
  ...
  //popup view details for edit
  const getFamilyDetailsEdit = (studentId) => {
    console.log('Getting student family details for ID:', studentId);
    axios
      .get(`${config.ApiUrl}Family/GetFamilyByStudentId/${studentId}`)
      .then((result) => {
        setEditedFamilyMember(result.data); // Set editedStudent when getting details
  ...
  // Function to update edited family member details
  const handleUpdateFamilyMember = (index) => {
    if (editedFamilyMember && editedFamilyMember[index]) {
      axios
        .put(`${config.ApiUrl}Family/PutFamily/${editedFamilyMember[index].id}`, editedFamilyMember[index])
        .then((response) => {
        toast.success('Parents details updated successfull');
        getData(); // Refresh data after update
        })
        .catch((error) => {
          toast.error('Failed to update parents details');
 ...
 //add family detailes
  ...
  return (
        ...
        <AdminSidebar>
          <>
            <Fragment>
              ...
              <>
                <Popup
                  contentStyle={{ width: "1580px", height: '640px', borderRadius: '10px', background: 'lightgray' }}
                  ...
                  {editedStudent && (
                    <div id='edit-popup'>
                     ...
                     {/* family member upadting */}
                      ...
                      <div id='family_div'>
                        {editedFamilyMember && editedFamilyMember.map((member, index) => (
                          <div id='family-card' key={index}>
                            <p id='parentrelation'>{member.relation}</p>
                            <label id='family_label'>Name:</label>
                            <input
                              id='family_name'
                              type='text'
                              value={member.name}
                              onChange={(e) =>
                                setEditedFamilyMember(prevState => {
                                  const updatedFamilyMember = [...prevState];
                                  updatedFamilyMember[index] = { ...updatedFamilyMember[index], name: e.target.value };
                                  return updatedFamilyMember;
                                })}
                            />

                            <label id='family_label'>Email:</label>
                            <input
                              id='family_name'
                              type='text'
                              value={member.email}
                              onChange={(e) =>
                                setEditedFamilyMember(prevState => {
                                  const updatedFamilyMember = [...prevState];
                                  updatedFamilyMember[index] = { ...updatedFamilyMember[index], email: e.target.value };
                                  return updatedFamilyMember;
                                })}
                            />

                            <label id='family_label'>Occupation:</label>
                            <input
                              id='family_name'
                              type='text'
                              ...
                              onChange={(e) =>
                                setEditedFamilyMember(prevState => {
                                  const updatedFamilyMember = [...prevState];
                                  updatedFamilyMember[index] = { ...updatedFamilyMember[index], occupation: e.target.value };
                                  return updatedFamilyMember;
                                })}
                            />

                            <label id='family_label'>MobileNo:</label>
                            <input
                              id='family_name'
                              type='text'
                              ...
                              onChange={(e) =>
                                setEditedFamilyMember(prevState => {
                                  const updatedFamilyMember = [...prevState];
                                  updatedFamilyMember[index] = { ...updatedFamilyMember[index], mobileNumber: e.target.value };
                                  return updatedFamilyMember;
                                })}
                            />

                            <button id='family_update' onClick={() => handleUpdateFamilyMember(index)}>Update</button>
   ...
   <>
        <Fragment>
         <h2 id='searchstudenth2'>Search Student</h2>           <div id="search-container">
         <input
                  id="searchstudentbutton"
                  type="text"
                  placeholder="Search By Name..."
